...
class StoreStudentRequest extends FormRequest
{
    ...
    protected function prepareForValidation(): void
    {
        $this->merge([
            ...
            'username' => $this->normalize($this->input('username')),
    ...
    public function rules(): array
    {
        ...
        if ($this->filled('username') || $this->filled('password')) {
            $emailRules[] = Rule::unique('user_accounts', 'email');
        }
        ...
        return [
            ...
            'username' => ['nullable', 'required_with:password', 'string', 'max:255', Rule::unique('user_accounts', 'username')],
            'email' => $emailRules,
